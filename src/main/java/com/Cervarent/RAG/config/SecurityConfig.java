...
import com.Cervarent.RAG.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    /**
     * IMPORTANT : remplacer "http://localhost:5173" par le vrai domaine du
     * frontend en production. Ne JAMAIS remettre "*" une fois l'authentification
     * en place (incompatible avec l'envoi de credentials/Authorization header).
     */
    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
            "http://localhost:5173",
            "https://rag-argentique.onrender.com"
        ));
